...
<div class="sidebar position-absolute top-0 start-0 position-fixed"
    ...
    <ul class="nav nav-pills flex-column mb-auto text-white" style="padding-left: 20px; padding-right: 20px;">
        ...
        <li>
            <a href="././../public/index.php?page=dosen_pengumuman_list" class="nav-link <?php echo (isset($_GET['page']) && $_GET['page'] == 'dosen_pengumuman_list') ? 'active' : ''; ?> link-body-emphasis text-white" style="padding: 14px;">
                <i class="bi bi-trophy me-2"></i>
                Pengumuman
            </a>
        </li>
